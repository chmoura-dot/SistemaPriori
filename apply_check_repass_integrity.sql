-- ============================================================
-- FASE 2 — RPC de paridade financeira do repasse
-- ============================================================
-- Rode este script no SQL Editor do Supabase (produção).
-- É idempotente (CREATE OR REPLACE) — seguro reexecutar.
-- Conteúdo idêntico à migration 20260716c_check_repass_integrity.sql.
-- ============================================================
...
SELECT proname FROM pg_proc
 WHERE proname IN ('calc_repass_rule', 'check_repass_integrity')
 ORDER BY proname;
