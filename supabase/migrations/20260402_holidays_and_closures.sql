...
-- Pré-carregar feriados nacionais, estaduais e municipais de Niterói para 2026
-- NOTA: São Sebastião (20/jan) é feriado do MUNICÍPIO DO RIO DE JANEIRO, não de Niterói.
INSERT INTO holidays (date, name, type, recurring, clinic_open) VALUES
  ...
  ('2026-06-05', 'Ponto Facultativo Municipal (após Corpus Christi)', 'facultativo', false, true),
  ...
  ('2026-11-22', 'Aniversário de Niterói', 'municipal', true, false),
