-- ============================================================================
-- Migration: RPCs atômicas para lotes de faturamento
-- Data: 2026-09-10
-- Causa raiz: billing_batches.appointment_ids (array) e appointments.billing_batch_id
--   (coluna) são duas representações do mesmo vínculo lote↔atendimento, hoje
--   mantidas por chamadas HTTP separadas ao Supabase (sem transação). Uma falha
--   no meio de qualquer sequência (rede, RLS, timeout) deixa as duas fontes
--   dessincronizadas — já aconteceu em produção (ver fix_zombie_billing_refs.sql).
--   Estas duas funções tornam essas operações atômicas.
-- ============================================================================
